...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO transactions (user_id, account_id, type, amount, transfer_proof, description) VALUES (?, ?, 'deposit', ?, ?, ?)");
    $stmt->execute([$_SESSION['user']['id'], $account_id, $amount, $proof, $description]);
    ...
    <div class="flex min-h-screen">
        ...
        <div id="sidebar" class="sidebar bg-white border-r border-gray-200 p-5 fixed h-full z-50 md:relative md:left-0">
            ...
            <nav class="space-y-1">
                ...
                <a href="#" class="block py-2 px-4 text-gray-600 bg-gray-100 rounded-lg font-medium"><i class="fas fa-arrow-down mr-2"></i> Simpan Uang</a>
        ...
        <div id="main-content" class="flex-1 p-4 md:p-6 overflow-y-auto main-content md:ml-0 md:pl-2">
            ...
            <h1 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                <i class="fas fa-arrow-down mr-2 text-blue-600"></i> Simpan Uang
            </h1>
            ...
            <div class="bg-white p-4 md:p-6 rounded-lg border border-gray-100 shadow-sm max-w-lg">
                <form method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="file" name="proof" accept="image/*" class="w-full p-3 border border-gray-200 rounded-lg text-gray-600">
                    </div>
                    <div>
                    ...
                    <button type="submit" class="btn-primary text-white p-3 rounded-lg w-full font-medium">Simpan Uang</button>
                </form>
            </div>
        </div>
    </div>
